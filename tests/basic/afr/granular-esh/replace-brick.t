...
EXPECT "000000010000000100000001" get_hex_xattr user.afr.$V0-client-1 $B0/${V0}0

# Also ensure we don't mistakenly tamper with the new brick's changelog xattrs
EXPECT "000000000000000000000001" get_hex_xattr user.afr.$V0-client-0 $B0/${V0}1_new
...
EXPECT "000000000000000000000000" get_hex_xattr user.afr.$V0-client-1 $B0/${V0}0
EXPECT "000000000000000000000000" get_hex_xattr user.afr.$V0-client-0 $B0/${V0}1_new
EXPECT "000000000000000000000000" get_hex_xattr user.afr.dirty $B0/${V0}1_new
