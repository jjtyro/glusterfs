...
TEST touch $M0/b.txt
EXPECT "000000000000000000000001" get_hex_xattr user.afr.$V0-client-0 $B0/brick1
EXPECT "000000010000000200000000" get_hex_xattr user.afr.$V0-client-0 $B0/brick1/b.txt
#New entry mark lead to pending data on the file and on ta
EXPECT "000000010000000100000000" get_hex_xattr user.afr.$V0-client-0 $B0/ta/user.afr.patchy-ta-2
