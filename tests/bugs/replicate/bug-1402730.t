...
EXPECT_NOT "00000000" afr_get_specific_changelog_xattr $B0/${V0}0/a/b/c user.afr.$V0-client-2 entry
EXPECT_NOT "00000000" afr_get_specific_changelog_xattr $B0/${V0}1/a/b/c user.afr.$V0-client-2 entry
