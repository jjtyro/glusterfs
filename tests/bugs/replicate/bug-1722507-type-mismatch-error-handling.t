...
setfattr -n user.afr.$V0-client-1 -v 0x000000000000000000000001 $B0/$V0"0"/dir
...
TEST setfattr -x user.gfid $B0/${V0}0/dir/file
...
TEST setfattr -x user.gfid $B0/${V0}0/dir/file
TEST rm -f $B0/${V0}0/.glusterfs/${gfid_str_file:0:2}/${gfid_str_file:2:2}/$gfid_str_file
TEST setfattr -x user.gfid $B0/${V0}1/dir/file
