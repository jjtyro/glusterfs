...
#Trigger user.glusterfs.mdata setting codepath and see things work as expected
cleanup
...
TEST setfattr -x user.glusterfs.mdata $B0/$V0/test
EXPECT_WITHIN $UMOUNT_TIMEOUT "Y" force_umount $M0
$GFS --volfile-id=/$V0 --volfile-server=$H0 $M0;
su ${TEST_USER} -c "cat $M0/test"
TEST getfattr -n user.glusterfs.mdata $B0/$V0/test
